            ...
            <div id="Footer" className="border-t mt-20 px-2">
                <div className="flex items-baseline justify-between w-full mx-auto max-w-[1200px] py-10">
                    ...
                    <ul className="text-gray-700">
                        ...
                        <li className="mt-2 py-1 text-xs hover:underline cursor-pointer">eBay's Blogs</li>
                        <li className="py-1 text-xs hover:underline cursor-pointer">Facebook</li>
                        <li className="py-1 text-xs hover:underline cursor-pointer">Twitter</li>
                    </ul>
                    <ul className="text-gray-700">
                    ...
                    <ul className="text-gray-700">
                        ...
                        <li className="mt-2 py-1 text-xs hover:underline cursor-pointer">Seller Information Center</li>
                        <li className="py-1 text-xs hover:underline cursor-pointer">Contact Us</li>
                        <li className="py-1 text-xs hover:underline cursor-pointer">Discussion boards</li>
                    </ul>
                </div>
            </div>
        </>
